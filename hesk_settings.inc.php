...
// $hesk_settings['site_title'] = 'Portal';
// $hesk_settings['site_url'] = 'http://localhost:85';
// $hesk_settings['hesk_title'] = 'Helpdesk Puskesmas Balaraja';
// $hesk_settings['hesk_url'] = 'http://localhost:85/hesk';
// $hesk_settings['webmaster_mail'] = 'helpdesk@puskesmasbalaraja.com';
// $hesk_settings['site_theme'] = 'hesk3';
// $hesk_settings['admin_css'] = 1;
// $hesk_settings['admin_css_url'] = 'http://localhost:85/hesk-style.css';
// $hesk_settings['admin_js'] = 1;
// $hesk_settings['admin_js_url'] = 'http://localhost:85/hesk-script.js';

// --> General settings Public
$hesk_settings['site_title'] = 'Portal';
$hesk_settings['site_url'] = 'http://helpdesk.puskesmasbalaraja.com';
$hesk_settings['hesk_title'] = 'Helpdesk Puskesmas Balaraja';
$hesk_settings['hesk_url'] = 'http://helpdesk.puskesmasbalaraja.com';
$hesk_settings['webmaster_mail'] = 'helpdesk@puskesmasbalaraja.com';
$hesk_settings['site_theme'] = 'hesk3';
$hesk_settings['admin_css'] = 1;
$hesk_settings['admin_css_url'] = 'http://helpdesk.puskesmasbalaraja.com/hesk-style.css';
$hesk_settings['admin_js'] = 1;
$hesk_settings['admin_js_url'] = 'http://helpdesk.puskesmasbalaraja.com/hesk-script.js';

// --> Language settings
$hesk_settings['can_sel_lang'] = 1;
$hesk_settings['language'] = 'Indonesia';
$hesk_settings['languages'] = array(
    'Indonesia' => array('folder' => 'id', 'hr' => '------ Reply above this line ------'),
);

// // --> Database Local settings
// $hesk_settings['db_host']='localhost';
// $hesk_settings['db_name']='helpdesk2';
// $hesk_settings['db_user']='root';
// $hesk_settings['db_pass']='';
// $hesk_settings['db_pfix']='hesk_';

// --> Database Public settings
$hesk_settings['db_host'] = 'helpdesk.puskesmasbalaraja.com';
$hesk_settings['db_name'] = 'puskesm6_helpdesk';
$hesk_settings['db_user'] = 'puskesm6_alfianaji24';
$hesk_settings['db_pass'] = 'Nzlpngcq007';
$hesk_settings['db_pfix'] = 'hesk_';
...
$hesk_settings['question_ask'] = 'Type <i>MW55A</i> here to fight SPAM:';
$hesk_settings['question_ans'] = 'MW55A';
...
$hesk_settings['url_key'] = 'KWfj.R4xfypwjP-xH2Nt';
...
$hesk_settings['kb_popart'] = 0;
$hesk_settings['kb_latest'] = 0;
$hesk_settings['kb_index_popart'] = 0;
$hesk_settings['kb_index_latest'] = 0;
$hesk_settings['kb_related'] = 0;
